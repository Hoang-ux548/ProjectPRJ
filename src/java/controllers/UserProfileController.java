...
public class UserProfileController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<UserProfile> users = uDao.getUserProfile();
        
        request.setAttribute("profileList", users);
        request.getRequestDispatcher("Views/UserProfileList.jsp").forward(request, response);
    }
